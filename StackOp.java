	             ...
	             {   
	                 case 1:System.out.println("Enter element: ");   
	                                 int val = sc.nextInt();   
	                                  st.push(val);   
	                                   break;   
	                 case 2:System.out.println("Enter two elements: ");   
	                                 int v1 = sc.nextInt();   
	                                 int v2 = sc.nextInt();   
	                                st.push(v1, v2);   
	                                 break;   
	                 case 3:int popped = st.pop();
	                                 ...
	                                 break;   
	                 case 4:System.out.println("Enter number of elements to pop: ");   
	                                int n = sc.nextInt();   
	                 ...
	                 case 5:st.display();   
	                               break;  
	                 case 6:System.out.println("Enter number of top elements: ");   
	                                int topN = sc.nextInt();   
	                                st.display(topN);   
	                                break;   
